...
public class Tree {
	...
	public Tree(String x)throws Exception{							
	...
	public String count(){				//includes folder
	...
	public String getParentPath(Node p){		//unused
	...
	public boolean insertDirect(String c)throws Exception{		//no restrictions
		if(c.length() < 1 || c.charAt(1) != ':')
			return false;
		if(!c.contains(root.path))
			return false;
		window.append("inserted " + c);
	...
	public boolean delete(String h)throws Exception{
	...
	public boolean deleteRec(String s)throws Exception{
