...
//					if(r.children[i] != nnnn)
	 ...
	 */
	protected int insertFile(String h, String hj)throws GreaterThanMaxException, IOException, FileNotFoundException{
		int x = 0;
		...
		else if(searchPath(h)){		//direct parent does not exist
			x = 1;
		}
		File f = new File(h);
		if(!f.exists())
