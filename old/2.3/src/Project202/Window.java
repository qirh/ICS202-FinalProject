...
public class Window extends JFrame implements AWTEventListener{
	...
	private JButton btnInsertFile;	private JButton secert;
	...
	public Window(Tree x) {
		...
		btnInsertFile = new JButton("Insert File");
		btnInsertFile.setBounds(5, 85, 180, 25);
		...
		btnPrintBFT.setBounds(5, 365, 180, 25);
		contentPane.add(btnPrintBFT);
		btnPrintBFT.addActionListener(l);
		
		btnCount = new JButton("Count");
		btnCount.setBounds(5, 400, 180, 25);
		contentPane.add(btnCount);
		btnCount.addActionListener(l);
		
		btnReset = new JButton("Reset");
		btnReset.setBounds(5, 435, 180, 25);
		contentPane.add(btnReset);
		btnReset.addActionListener(l);
		
		secert = new JButton("              ");
		secert.setBounds(5, 470, 180, 25);
		contentPane.add(secert);
		secert.addActionListener(l);
		secert.setBackground(contentPane.getBackground());
		secert.setForeground(contentPane.getBackground());
